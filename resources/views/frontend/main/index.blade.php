                            ...
                            <div class="col-md-12 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="blog-item">
                                    ...
                                    <div class="blog-content rounded-bottom p-4">
                                        <a href="#" class="h6 d-inline-block mb-3">{{ \Str::limit($news->title, 60) }}</a>
                                        <p>{{ \Str::limit($news->description, 100) }}</p>
                                        <a href="{{ route('berita.index') }}" class="fw-bold text-secondary">Selengkapnya <i class="fa fa-angle-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
